...
const String noonKey = "noon";
const String eveningKey = "evening";
const String nightKey = "night";
const String amKey = "am";
const String pmKey = "pm";
...
const String markAllPresentKey = "markAllPresent";
const String markAllAbsentKey = "markAllAbsent";
...
const String presentShortKey = "presentShort";
const String absentShortKey = "absentShort";
...
const String janShortKey = "janShort";
const String febShortKey = "febShort";
const String marShortKey = "marShort";
const String aprShortKey = "aprShort";
const String mayShortKey = "mayShort";
const String junShortKey = "junShort";
const String julShortKey = "julShort";
const String augShortKey = "augShort";
const String sepShortKey = "sepShort";
const String octShortKey = "octShort";
const String novShortKey = "novShort";
const String decShortKey = "decShort";
...
const String pleaseAddAtLeastOneMarkForDraftKey =
    "pleaseAddAtLeastOneMarkForDraft";
...
const String certificatesKey = "certificates";
...
// Teacher Tracker / Task Keys
const String myTaskKey = "myTask";
const String myTasksKey = "myTasks";
const String noTasksFoundKey = "noTasksFound";
const String overdueKey = "overdue";
const String youCompleteTaskOnKey = "youCompleteTaskOn";
const String taskOverdueByDaysKey = "taskOverdueByDays";
const String addTaskKey = "addTask";
const String taskNameKey = "taskName";
const String pleaseEnterTaskNameKey = "pleaseEnterTaskName";
const String pleaseSelectDueDateKey = "pleaseSelectDueDate";
const String taskDetailsKey = "taskDetails";
const String startTaskKey = "startTask";
const String markAsCompleteKey = "markAsComplete";
const String editTaskKey = "editTask";
const String deleteTaskKey = "deleteTask";
const String taskTitleLabelKey = "taskTitleLabel";
const String assignedByAdminKey = "assignedByAdmin";
const String staffTaskLabelKey = "staffTaskLabel";
const String createdOnKey = "createdOn";
const String manageTasksKey = "manageTasks";
const String manageTaskKey = "manageTask";
const String myselfKey = "myself";
const String staffKey = "staff";
const String assignTaskKey = "assignTask";
const String selectStaffForTaskKey = "selectStaffForTask";
const String selectStaffKey = "selectStaff";
const String assignToKey = "assignTo";
const String adminTaskKey = "adminTask";
const String assignedToKey = "assignedTo";
const String detailsKey = "details";
const String tasksKey = "tasks";
const String staffProfileKey = "staffProfile";
const String assignTaskButtonKey = "assignTaskButton";
const String createdByKey = "createdBy";
const String noTasksAssignedKey = "noTasksAssigned";

// Task CRUD Keys
const String taskCreatedSuccessKey = "taskCreatedSuccess";
const String taskUpdatedSuccessKey = "taskUpdatedSuccess";
const String taskDeletedSuccessKey = "taskDeletedSuccess";
const String deleteTaskConfirmKey = "deleteTaskConfirm";
const String pleaseEnterDescriptionTaskKey = "pleaseEnterDescriptionTask";
const String taskStartedSuccessKey = "taskStartedSuccess";
const String taskCompletedSuccessKey = "taskCompletedSuccess";
const String pleaseSelectStaffKey = "pleaseSelectStaff";
const String changeStatusKey = "changeStatus";
const String pleaseSelectStatusKey = "pleaseSelectStatus";

// Transport Plan History Keys
const String planHistoryKey = "planHistory";
const String shiftKey = "shift";
const String expiredKey = "expired";
const String estimatedPickupTimeKey = "estimatedPickupTime";
const String estimatedKey = "estimated";

// Plan Renewal Screen Keys
const String currentPlanKey = "currentPlan";
const String planKey = "plan";
const String totalFeeKey = "totalFee";
const String noChangesToRouteOrPickupKey = "noChangesToRouteOrPickup";
const String loadingFeesKey = "loadingFees";
const String failedToLoadFeesKey = "failedToLoadFees";
const String planDetailsNotAvailableKey = "planDetailsNotAvailable";
const String feeInformationNotAvailableKey = "feeInformationNotAvailable";
const String loadingKey = "loading";
const String grNoKey = "grNo";

// Online Class Keys
const String onlineClassKey = "onlineClass";
const String onlineClassesKey = "onlineClasses";
const String createOnlineClassKey = "createOnlineClass";
const String editClassKey = "editClass";
const String classDetailsKey = "classDetails";
const String onlineClassSummaryKey = "onlineClassSummary";
const String liveKey = "live";
const String pastKey = "past";
const String noRepeatKey = "noRepeat";
const String everyClassKey = "everyClass";
const String weeklyKey = "weekly";
const String selectRepeatKey = "selectRepeat";
const String whichPeriodKey = "whichPeriod";
const String selectSubjectKey = "selectSubject";
const String meetingLinkKey = "meetingLink";
const String timeKey = "time";
const String repeatKey = "repeat";
const String startDateKey = "startDate";
const String endDateKey = "endDate";
const String updateClassKey = "updateClass";
const String createClassKey = "createClass";
const String deleteClassKey = "deleteClass";
const String deleteOnlineClassKey = "deleteOnlineClass";
const String deleteOnlineClassConfirmKey = "deleteOnlineClassConfirm";
const String noOnlineClassesFoundKey = "noOnlineClassesFound";
const String noRepeatHelperKey = "noRepeatHelper";
const String everyClassHelperKey = "everyClassHelper";
const String weeklyHelperKey = "weeklyHelper";
const String selectPeriodHelperKey = "selectPeriodHelper";
const String allPeriodsIncludedKey = "allPeriodsIncluded";
const String weeklyScheduleNoteKey = "weeklyScheduleNote";
const String summaryNoRepeatNoteKey = "summaryNoRepeatNote";
const String summaryWeeklyNoteKey = "summaryWeeklyNote";
const String summaryEveryClassNoteKey = "summaryEveryClassNote";
const String pleaseSelectSubjectKey = "pleaseSelectSubject";
const String pleaseSelectPeriodKey = "pleaseSelectPeriod";
const String pleaseSelectEndDateKey = "pleaseSelectEndDate";
const String pleaseEnterMeetingLinkKey = "pleaseEnterMeetingLink";
const String onlineClassCreatedKey = "onlineClassCreated";
const String onlineClassUpdatedKey = "onlineClassUpdated";
const String onlineClassDeletedKey = "onlineClassDeleted";
const String editCategoryKey = "editCategory";
const String addNewCategoryKey = "addNewCategory";
const String enterTitleKey = "enterTitle";
const String titleIsRequiredKey = "titleIsRequired";
const String loadingCategoriesKey = "loadingCategories";
const String failedToLoadCategoriesKey = "failedToLoadCategories";
const String failedToLoadCategoriesRetryingKey =
    "failedToLoadCategoriesRetrying";
const String loadingSubjectsKey = "loadingSubjects";
const String failedToLoadSubjectsKey = "failedToLoadSubjects";
const String failedToLoadSubjectsRetryingKey = "failedToLoadSubjectsRetrying";
const String pleaseFillRequiredFieldKey = "pleaseFillRequiredField";
const String additionalInformationKey = "additionalInformation";
const String maleKey = "male";
const String femaleKey = "female";
const String noSubjectsFoundForClassKey = "noSubjectsFoundForClass";
const String classSectionNotAvailableKey = "classSectionNotAvailable";
const String pleaseSelectAtLeastOneStudentKey = "pleaseSelectAtLeastOneStudent";
const String classSectionInfoMissingKey = "classSectionInfoMissing";
const String noPermissionToCreateDiaryKey = "noPermissionToCreateDiary";
const String noStudentsSelectedKey = "noStudentsSelected";
const String creatingKey = "creating";
const String failedToCreateDiaryKey = "failedToCreateDiary";
const String failedToOpenManageCategoriesKey = "failedToOpenManageCategories";
const String noCategoriesLoadedKey = "noCategoriesLoaded";
const String manageKey = "manage";
const String applyKey = "apply";
const String manageCategoryKey = "manageCategory";
const String deleteCategoryKey = "deleteCategory";
const String areYouSureDeleteCategoryKey = "areYouSureDeleteCategory";
const String noCategoriesFoundKey = "noCategoriesFound";
const String categoryCreatedSuccessfullyKey = "categoryCreatedSuccessfully";
const String categoryUpdatedSuccessfullyKey = "categoryUpdatedSuccessfully";
const String categoryDeletedSuccessfullyKey = "categoryDeletedSuccessfully";
const String failedToCreateCategoryKey = "failedToCreateCategory";
const String failedToUpdateCategoryKey = "failedToUpdateCategory";
const String failedToDeleteCategoryKey = "failedToDeleteCategory";
const String allCategoriesKey = "allCategories";
const String allSubjectsKey = "allSubjects";
const String subjectsKey = "subjects";
const String categoriesKey = "categories";
const String noDescriptionKey = "noDescription";
const String justNowKey = "justNow";
const String daysAgoKey = "daysAgo";
const String hoursAgoKey = "hoursAgo";
const String minutesAgoKey = "minutesAgo";
const String dayAgoKey = "dayAgo";
const String monthlyKey = "monthly";
const String quarterlyKey = "quarterly";
const String yearlyKey = "yearly";
const String daysKey = "days";
const String hourAgoKey = "hourAgo";
const String minuteAgoKey = "minuteAgo";
const String countryCodeKey = "countryCode";
const String selectCountryCodeKey = "selectCountryCode";
const String searchCountryCodeKey = "searchCountryCode";
const String noCountryCodesFoundKey = "noCountryCodesFound";
